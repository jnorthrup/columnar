...
suspend fun main() {
    ...
    val s = "/vol/aux/rejuve/rejuvesinceapril2019.fwf"
    val fixedRecordLengthFile = com.fnreport.mapper.FixedRecordLengthFile(s)
...
var t=    measureTimeMillis {
     ...
     System.err.println("$t ms for 2.5 mil rows with distinct: ${dist.size}")
