...
val IOVECS_LEN = 2
//@JvmStatic
public fun fixedlink(argv:Array<String>): Unit= memScoped{val argc:Int=argv.size
	val iovecs: CArrayPointer<iovec>/*[IOVECS_LEN]*/= calloc( sizeOf <iovec>().toULong(), IOVECS_LEN.toULong())!!.reinterpret()
