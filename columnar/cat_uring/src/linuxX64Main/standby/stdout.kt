...
static test_pipe_io_fixed:Int(ring:CPointer<io_uring>) {
...
static test_stdout_io_fixed:Int(ring:CPointer<io_uring>) {
    const char str[] = "This is a fixed pipe test\n";
    cqe:CPointer<io_uring_cqe>;
    sqe:CPointer<io_uring_sqe>;
    vecs:iovec;
...
static test_stdout_io:Int(ring:CPointer<io_uring>) {
    cqe:CPointer<io_uring_cqe>;
    sqe:CPointer<io_uring_sqe>;
    vecs:iovec;
    ret:Int;
