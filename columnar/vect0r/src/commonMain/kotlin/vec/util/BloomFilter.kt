...
public class BloomFilter(n: Int, m: Int = n * 11  /* good for 31 bit ints*/,
...
// Maximum value returned + 1
        ...
        private val count: Int, var seed: Long = seed1++,
